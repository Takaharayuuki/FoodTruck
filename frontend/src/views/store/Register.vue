            ...
            <div class="shadow overflow-hidden sm:rounded-md">
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-12 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-5">
                    ...
                    <input
                      ...
                      class="px-2 h-10 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm border border-gr sm:text-sm border-gray-300 rounded-md"
                    />
                    ...
                    <div class="grid grid-cols-8 gap-6 mb-2">
                      <div class="postal">
                        ...
                        <input
                          ...
                          class="px-2 mt-1 h-10 border focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                        <span
                  ...
                  <div class="col-span-12">
                    ...
                    <input
                      ...
                      class="px-2 h-10 border mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                    />
                  </div>
                ...
                <p class="text-sm mb-1">
                  商品情報を入力し、「商品を登録する」ボタンを押下してください。
                  <br />複数商品の登録も可能です。
                </p>
                <span class="text-red-600" v-if="errors.product !== ''">{{ errors.product }}</span>
                <!-- TODO: コンポーネント化する -->
                <div
                  class="grid grid-cols-12 gap-6 shadow-md overflow-hidden sm:rounded-md px-4 py-5"
                ...
                >
                  ...
                  <div class="col-span-6 sm:col-span-4">
                    ...
                    <input
                      ...
                      class="text-right px-2 h-10 mt-1 inline-block focus:ring-indigo-500 focus:border-indigo-500 shadow-sm border border-gr sm:text-sm border-gray-300 rounded-md"
                    />
                  ...
                  <div class="col-span-12 text-right cursor-pointer">
                    <span
                      @click="addProduct"
                      class="bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow overflow-hidden sm:rounded-md text-white text-sm py-2 px-4 mr-4"
                    >＋商品を登録する</span>
                  </div>
                </div>
                <!-- ./商品登録 -->
              ...
              <div class="px-4 py-3 bg-gray-50 text-center sm:px-6">
                <button
                  type="submit"
                  class="inline-flex justify-center py-2 px-12 border border-transparent shadow-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >登録する</button>
              </div>
            </div>
          </form>
