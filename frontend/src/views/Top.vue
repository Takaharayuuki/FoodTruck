<template>
  <div>
    <div style="padding-top: 16rem" class="w-full mx-auto max-w-7xl px-6 sm:px-6 lg:px-8">
      <h2 class="title-font md:text-5xl text-3xl mb-4 font-medium" style="color: #333333; line-height: 1.3">
        近くの移動販売車、出店<br />
        キッチンカーを探す
      </h2>
    </div>
    ...
    <div class="w-full flex items-center justify-center relative">
      ...
      <div class="flex items-center justify-center p-48 pb-12 px-6 sm:px-6 lg:px-8 max-w-7xl w-full">
        <div class="w-full mx-auto">
          <div class="w-full bg-white shadow-md border rounded px-8 pt-6 pb-8 mb-4">
            <div class="grid grid-cols-12">
              <div class="md:col-span-8 col-span-12 flex relative rounded-md shadow-sm">
                ...
                <input v-model="searchArea" type="text" name="area" class="h-12 border border-l-0 border-yellow-700 focus:ring-yellow-600 focus:border-b-yellow-600 block w-full pl-3 text-sm rounded-sm" placeholder="エリア・駅 [例:池袋,渋谷]" />
              </div>
